...
class NemotronHConfig(PretrainedConfig):
    ...
    Args:
        vocab_size (`int`, *optional*, defaults to 131072):
            Vocabulary size of the NemotronH model. Defines the number of different tokens that
        ...
        hybrid_override_pattern (`str`, *optional*):
            The pattern of the hybrid model. Each character represents M: Mamba2,
            *: Attention, -: MLP. Default: "M-M-M-M*-M-M-M-M-M*-..."
        ...
        residual_in_fp32 (`bool`, *optional*, defaults to `False`):
            Whether or not residuals should be in `float32`. If set to `False` residuals
            will keep the same `dtype` as the rest of the model.
