...
def main():
    ...
    ref_data = torch.load(args.reference, map_location="cpu", weights_only=args.trust_inputs)
    ...
    # These files are expected to be generated by save_multi_layer_outputs() in this module,
    # not from untrusted sources. Users should only load files they generated themselves.
    comp_data = torch.load(args.compare, map_location="cpu", weights_only=args.trust_inputs)
